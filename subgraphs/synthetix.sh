...
http post 127.0.0.1:8020 jsonrpc="2.0" id="3" method="subgraph_deploy" params:='{"name": "synthetixio-team/synthetix", "ipfs_hash": "QmSXzWZhbDgDg9YyDeivFqYBc1zxESyBYBH3W9CzmupYQd", "node:id":"graph_node1"}'
